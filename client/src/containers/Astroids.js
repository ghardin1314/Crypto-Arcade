          ...
          >
            <Grid item md>
              <Typography component="h5" variant="h6">
                ...
                game per token and if you make it into the top 50% of scores by
                the end of the month, you get a payout! After a cut to fund the
                dev team, the winnings are paid out quadratically, so the higher
                your placing, the higher your payout! Scores are reset every
                month.
                <br />
                <br />
                ...
                <br />
                <br />
                Dont want to go through the hassle of getting funds? See if you
                can beat the top scores on the leaderboard in a free game! 
              </Typography>
            </Grid>
            <Grid
              container
